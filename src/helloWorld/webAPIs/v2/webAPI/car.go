...
func init() {
	...
	ginServer.AddRouterGroup("/api/v2", "/singleCars", "GET", getSingleCars)
	ginServer.AddRouterGroup("/api/v2", "/searchCars", "GET", getSearchCars)
	ginServer.AddRouterGroup("/api/v2", "/sortCars", "GET", getSortCars)
	ginServer.AddRouterGroup("/api/v2", "/rangeCars", "GET", getRangeCars)
	ginServer.AddRouterGroup("/api/v2", "/cars", "GET", getCars)
	ginServer.AddRouterGroup("/api/v2", "/car", "POST", postCar)
	ginServer.AddRouterGroup("/api/v2", "/car", "PUT", putCar)
	ginServer.AddRouterGroup("/api/v2", "/car", "DELETE", deleteCar)
}
